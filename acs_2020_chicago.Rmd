...
data %>%
  ...
  kable(caption = "Shifts in Share of Chicago Population by Race/Ethnicity") %>%
  kable_styling(latex_options = "striped")
```
...
data %>%
  ...
  select(year, total_families, poverty_pct, belowpoverty_families, belowpoverty_rent_families, belowpoverty_own_families, poverty_rent_pct, poverty_own_pct) %>% 
  kable() %>%
  kable_styling(latex_options = "striped")
```
